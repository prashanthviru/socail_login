                                ...
                                <div class="col-md-10">
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <form class="form-material" enctype="multipart/form-data"     action="{{url('/')}}/edit_profile" method="POST">
                                                @csrf
                                                <input type="hidden" name="id" value="{{$profile->id}}">
                                                <div class="form-group form-default">
                                                    <input type="text" class="form-control @if($profile->name != '') {{"fill"}} @endif" value="{{$profile->name}}" id="name" name="name" aria-describedby="name"  required>
                                                    <span class="form-bar"></span>
                                                    <label class="float-label">Name</label>
                                                </div>
                                                <div class="form-group form-default">
                                                    <input type="email" class="form-control @if($profile->email != '') {{"fill"}} @endif" value="{{$profile->email}}" id="email" name="email" aria-describedby="email"  required>
                                                    <span class="form-bar"></span>
                                                    <label class="float-label">Email</label>
                                                </div>
                                                <div class="form-group form-default">
                                                    <textarea row="5" class="form-control @if($profile->address != '') {{"fill"}} @endif" name="address">{{$profile->address}}</textarea>
                                                    <span class="form-bar"></span>
                                                    <label class="float-label">Address</label>
                                                </div>
                                                <div class="form-group form-default">
                                                    <input type="date" class="form-control fill" value="{{$profile->dob}}" id="dob" name="dob" aria-describedby="dob"  required>
                                                    <span class="form-bar"></span>
                                                ...
                                                <div class="form-group form-default">
                                                    <select class="form-control " id="education" name="education" required>
                                                        ...
                                                        <option value="B.E" @if($profile->education == "B.E") {{"Selected"}} @endif>B.E</option>
                                                        <option value="Diplamo" @if($profile->education == "Diplamo") {{"Selected"}} @endif>Diplamo</option>
                                                ...
                                                <div class="form-group form-default">
                                                    <select class="form-control" id="state" name="state" required>
                                                        ...
                                                        <option value="{{$stat->id}}" @if($profile->state_id == $stat->id) {{"selected"}} @endif>{{$stat->name}}</option>
                                                        @endforeach
                                                      </select>
                                                ...
                                                <div class="form-group checkbox-fade fade-in-primary d-">
                                                    <label>
                                                        <input type="radio" name="status" value="1" @if($profile->status == 1) {{"checked='true'"}} @endif>
                                                        <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
                                                        <span class="text-inverse">Active</span>
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="status" value="0" @if($profile->status == 0) {{"checked='true'"}} @endif>
                                                        <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
                                                ...
                                                <div class="form-group form-default">
                                                    <input type="number" class="form-control @if($profile->pincode != '') {{"fill"}} @endif" value="{{$profile->pincode}}" id="pincode" name="pincode" required aria-describedby="pincode">
                                                    <span class="form-bar"></span>
